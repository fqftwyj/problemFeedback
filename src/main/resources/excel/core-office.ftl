 ...
 <Worksheet ss:Name="Sheet1">
  ...
  <Table ss:ExpandedColumnCount="14" ss:ExpandedRowCount="41" x:FullColumns="1"
   ...
   <Row ss:AutoFitHeight="0" ss:Height="35.25">
    ...
    <Cell ss:StyleID="s68"><Data ss:Type="String">地点</Data><NamedCell
      ss:Name="Print_Area"/></Cell>
    <Cell ss:Index="9" ss:StyleID="s68"><Data ss:Type="String">天数</Data><NamedCell
      ss:Name="Print_Area"/></Cell>
    <Cell ss:StyleID="s68"><Data ss:Type="String">标准</Data><NamedCell
      ss:Name="Print_Area"/></Cell>
    <Cell ss:StyleID="s68"><Data ss:Type="String">金额</Data><NamedCell
      ss:Name="Print_Area"/></Cell>
    <Cell ss:StyleID="s68"><Data ss:Type="String">项目</Data><NamedCell
      ss:Name="Print_Area"/></Cell>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="45">
    <Cell ss:StyleID="s69"><Data ss:Type="String">${obj.departureTime!''}</Data><NamedCell
      ss:Name="Print_Area"/></Cell>
    ...
    <Cell ss:StyleID="s70"><Data ss:Type="String">${obj.arrivalPlace!''}</Data><NamedCell
      ss:Name="Print_Area"/></Cell>
    <Cell ss:StyleID="s71"><Data ss:Type="String">${obj.carboatType!''}</Data><NamedCell
      ss:Name="Print_Area"/></Cell>
    <Cell ss:StyleID="s71"><Data ss:Type="String">${obj.docNumber!''}</Data><NamedCell
      ss:Name="Print_Area"/></Cell>
    <Cell ss:StyleID="s72"><Data ss:Type="String">${obj.carboatfee!''}</Data><NamedCell
      ss:Name="Print_Area"/></Cell>
    <Cell ss:StyleID="s71"><Data ss:Type="String">${obj.days!''}</Data><NamedCell
      ss:Name="Print_Area"/></Cell>
    <Cell ss:StyleID="s71"><Data ss:Type="String">${obj.travelStandard!''}</Data><NamedCell
      ss:Name="Print_Area"/></Cell>
   ...
   <Row ss:Index="15">
    ...
    <Cell ss:StyleID="s74"><NamedCell ss:Name="Print_Area"/></Cell>
    <Cell ss:StyleID="s74"><NamedCell ss:Name="Print_Area"/></Cell>
    <Cell ss:StyleID="s74"><Data ss:Type="String">（请按费用类别分类粘贴）</Data><NamedCell
      ss:Name="Print_Area"/></Cell>
    <Cell ss:StyleID="s74"><NamedCell ss:Name="Print_Area"/></Cell>
    <Cell ss:StyleID="s74"><NamedCell ss:Name="Print_Area"/></Cell>
    <Cell ss:StyleID="s74"><NamedCell ss:Name="Print_Area"/></Cell>
