    ...
    public static String privacyInfo(String currString) {
        ...
        if (!StringHelper.isBlank(currString)) {
            if (currString.length() <= 3) {
                targetString = currString.replace(org.apache.commons.lang.StringUtils.substring(currString, 0, 1), "*");

            } else if (currString.length() > 3) {
                targetString = currString.replace(org.apache.commons.lang.StringUtils.substring(currString, 0, 2), "*");
            }
        }
